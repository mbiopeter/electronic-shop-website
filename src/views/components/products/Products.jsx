...
const Products = ({item, key}) => {
	...
	return (
		<div className="flex transition-transform duration-500 ease-in-out  pb-6 m-auto">
			<div key={key} className="h-[290px] w-[220px] m-5 ">
				<div className="bg-gray-100 rounded-sm h-55 flex flex-col ">
					<div className="flex justify-between">
						<p className="flex items-center h-6 w-12 bg-[#DB4444] m-3 justify-center rounded-md text-white text-xs p-2 font-semibold">
							{item.discount}%
						</p>
					...
					<div className="flex h-[90%] w-full overflow-hidden items-center justify-center cursor-pointer m-auto">
						<img
							src={item.img}
				...
				<div className="flex flex-row">
					<p className="text-red-500 font-semibold m-1">${item.price}</p>
